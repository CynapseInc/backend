...
public class PedidoController {
        ...
        @ApiResponse(responseCode = "201", description = "Cria um pedido", content = @Content(schema = @Schema(implementation = PedidoCreatedResponseDto.class)))
        @PostMapping
        ...
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Lista de pedidos", content = @Content(array = @io.swagger.v3.oas.annotations.media.ArraySchema(schema = @Schema(implementation = PedidoResponseDto.class))))
        })
        @GetMapping
        ...
        @ApiResponse(responseCode = "201", description = "Cria um pedido", content = @Content(schema = @Schema(implementation = PedidoResponseDto.class)))
        @GetMapping("/{id}")
        ...
        @ApiResponse(responseCode = "200", description = "Pedido atualizado", content = @Content(schema = @Schema(implementation = PedidoResponseDto.class)))
        @PutMapping("/{id}")
        ...
        @ApiResponse(responseCode = "200", description = "Mudou o estado do pedido", content = @Content(schema = @Schema(implementation = PedidoResponseDto.class)))
        ...
        @ApiResponse(responseCode = "200", description = "Mudou os status do pedido", content = @Content(schema = @Schema(implementation = PedidoResponseDto.class)))
        ...
        @ApiResponse(responseCode = "200", description = "Adicionou novo produto ao pedido", content = @Content(schema = @Schema(implementation = ProdutosPedidoResponseDto.class)))
        ...
        public ResponseEntity<ProdutosPedidoResponseDto> criarProdutoParaOPedido(
                ...
                ProdutoPedido produtoPedidoSalvo = produtoPedidoUseCase.salvar(produtoPedido, dto.idProduto(),
                                dto.idPedido());

                pedidoUseCase.atualizarPrecoPesoDoPedido(true, produtoPedidoSalvo.getPrecoTotal(),
                                produtoPedidoSalvo.getPesoTotal(), dto.idPedido());

                ProdutosPedidoResponseDto response = new ProdutosPedidoResponseDto(
        ...
        public ResponseEntity<Void> removerProdutoDeUmPedido(
                ...
                pedidoUseCase.atualizarPrecoPesoDoPedido(false, produtoPedido.getPrecoTotal(),
                                produtoPedido.getPesoTotal(), produtoPedido.getPedido().getId());
        ...
        // endpoints, criar novo produto para o pedido, atualizar pedido existente no
        // produto
